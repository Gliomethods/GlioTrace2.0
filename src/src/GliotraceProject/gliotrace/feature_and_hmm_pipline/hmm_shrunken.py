...
def forward_backward(
    ...
    Author: André Lasses Armatowski (adapted)
    """
...
def update_transitions(trajectories, xis, glm_iters=500, penalty=1, prev_models=None):
    """
...
def HMM_glm_cnn(
    ...
    return pi_ser, best_glm_models, A_df, gammas_long, best_lik
